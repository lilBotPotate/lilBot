...
module.exports = new Command.Admin()
      ...
      .addUse("winner", "select a random person on the server")
      .addUse("winner subs", "select a random subscriber on the server")
...
function selectWinner(msg, args) {
    ...
    return msg.channel.send(`${winner} `, {embed: eWinner});
}